...
/**
 * 
 * 类名称：FastJsonUtil 类描述： 创建人：wesley 创建时间：2015年7月29日 下午6:57:29
 * 
 */
public class FastJsonUtil {
	...
	public static <T> List<T> DeSerializeArray(JSONArray jsonArray,
			Class<T> clazz) {
	...
	public static String StrToJSONArray(String[] arr) {
